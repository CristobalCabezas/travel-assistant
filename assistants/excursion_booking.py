...
book_excursion_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "2. When user is interested in a trip/excursion or transfer service option, show the service options available for that trip/excursion or transfer service. "
            ...
            "Before you make the booking, you have to give a resume of the booking to the user. "
            ...
            "4. Cancel the trip/excursion or transfer service booking/reservation.\n"
            "If the user wants to cancel the excursion or transfer booking, you have to ask the user the Booking ID. "
            "Use the 'cancel_transport_or_excursion_booking' tool to cancel the booking.\n"
