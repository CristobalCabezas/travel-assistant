...
book_hotel_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "4. Update the hotel booking/reservation.\n"
            "If the user wants to modify or update the hotel booking, you have to ask the user the following information: "
            "a. The booking id. "
            "b. The element to modify or update. The user can modify the following features: "
            "additionalInformation: Any comments, observations or remarks addressed to the hotel; "
            "notes: Any comments, observations or remarks addressed to the booking customer or CTS Turismo itself; "
            "referenceNumber: The reference number."
            "If the user wants to update any comments, observations or remarks and not indicates who adress it, "
            "just update both fields. "
            "Use the 'update_hotel_booking' tool to update the hotel booking.\n"
            "5. Cancel the hotel booking/reservation.\n"
            "If the user wants to cancel the hotel booking, you have to ask the user the Booking ID. "
            "use the 'cancel_hotel_booking' tool to cancel the hotel booking.\n"
